...
yystate(27, [10|Ics], Line, Tlen, _, _) ->
    yystate(23, Ics, Line+1, Tlen+1, 17, Tlen);
...
yystate(10, [10|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line+1, Tlen+1, 15, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
...
yystate(3, [10|Ics], Line, Tlen, _, _) ->
    yystate(4, Ics, Line+1, Tlen+1, 17, Tlen);
